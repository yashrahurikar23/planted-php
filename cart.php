...
<div class="container pendingbody pt-4">
    ...
    $total=0;
      ...
      <tr>
        ...
        <td><form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
          ...
          <input type="number" name="update_quantity"  class="form-control "  style="max-width: 100px;" min="1"  value="<?php echo $row['quantity']; ?>" >
          <button type="submit" value="update" name="update_update_btn" class='btn btn-secondary'>Update</button>
        </form></td> 
  ...
  <div>
    <h5 class="mb-2">Enter address to order</h5>
